...
public class AliHttpUtils {
	 ...
	 */
	public static HttpResponse doPost(String host, String path, String method, Map<String, String> headers,
			Map<String, String> querys, List<NameValuePair> nameValuePairList) throws Exception {
		HttpClient httpClient = wrapClient(host);
	...
	public void test() {
		String host = "https://seveneight.xin";
		String path = "/card/CET/searchExamNum.do";
		String method = "POST";
		Map<String, String> headers = new HashMap<String, String>();
		Map<String, String> querys = new HashMap<String, String>();
		Map<String, String> bodys = new HashMap<String, String>();
		bodys.put("idcard", "123456");
